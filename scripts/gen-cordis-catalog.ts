...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planMode: 'plan.md',
  pluginMarketplace: 'extensions.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PluginMarketplaceCatalogRequest: 'extensions.md',
  PluginMarketplaceCatalogSnapshot: 'extensions.md',
  PluginMarketplaceConfirmImportRequest: 'extensions.md',
  PluginMarketplaceConfirmImportResult: 'extensions.md',
  PluginMarketplacePrepareImportRequest: 'extensions.md',
  PluginMarketplacePrepareImportResult: 'extensions.md',
  PluginMarketplaceResources: 'extensions.md',
  PluginMarketplaceValidateCatalogItemRequest: 'extensions.md',
  PluginMarketplaceValidateCatalogItemResult: 'extensions.md',
  ...
  ChannelAdmissionResult: 'channels.md',
  ChannelConsumer: 'channels.md',
  ChannelDeliveryReceipt: 'channels.md',
  ChannelInboundMessage: 'channels.md',
  ChannelOutboundMessage: 'channels.md',
  ChannelProvider: 'channels.md',
  TelegramBeginPairingResult: 'channels.md',
  TelegramChannelStatus: 'channels.md',
  TelegramConfirmPairingRequest: 'channels.md',
  TelegramConfirmPairingResult: 'channels.md',
  TelegramEnableResult: 'channels.md',
