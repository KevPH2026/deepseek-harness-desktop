...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-about-community': { kind: 'none', reason: 'Browser-side static attribution surface; registers nothing model-facing.' },
  ...
  'packages/host/plugin-marketplace': { kind: 'none', reason: 'Host-side discovery, validation, and import-planning service; registers nothing model-facing.' },
