...
import pluginMarketplaceRemote from '@deepseek-ai/dsh-host-plugin-marketplace/remote'
import channelTelegramRemote from '@deepseek-ai/dsh-channel-telegram/remote'
...
export type {
  ...
  TelegramConfirmPairingErrorCode,
  ...
  TelegramPairingCapability,
  TelegramPairingStatus,
  TelegramRuntimePhase,
  TelegramSetProxyErrorCode,
  TelegramSetProxyRequest,
  TelegramSetProxyResult,
} from '@deepseek-ai/dsh-channel-telegram/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-marketplace/remote'
export type {} from '@deepseek-ai/dsh-channel-telegram/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, pluginMarketplaceRemote,
      channelTelegramRemote,
