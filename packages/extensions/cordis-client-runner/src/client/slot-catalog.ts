...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-profile PublicProfileOnboarding id \'public-profile\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugin-inventory PluginMarketplaceSettingsTab id \'marketplace\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-about-community AboutCommunitySection id \'about-community\'',
      'client-ui-settings-channel-telegram TelegramSettingsSection id \'remote-channels\'',
      'client-ui-settings-general GeneralSection id \'general\'',
      'client-ui-settings-models ModelsSection id \'models\'',
      'client-ui-settings-plugins PluginsSettingsSection id \'plugins\'',
      'client-ui-settings-profile ProfileSettingsSection id \'profile\'',
      'media-generation MediaSettingsSection id \'media-generation\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, generate_image, generate_video, glob, grep, read, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'media-generation MediaToolCard key \'generate_image\'',
      'media-generation MediaToolCard key \'generate_video\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
