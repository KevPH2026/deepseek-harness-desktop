/** Telegram Settings stylesheet theme-token contract. */
import { readdirSync, readFileSync } from 'node:fs'
import { fileURLToPath } from 'node:url'
import { describe, expect, it } from 'vitest'

const css = readFileSync(fileURLToPath(new URL('../src/client/TelegramSettingsSection.module.css', import.meta.url)), 'utf8')
...
describe('TelegramSettingsSection theme styles', () => {
