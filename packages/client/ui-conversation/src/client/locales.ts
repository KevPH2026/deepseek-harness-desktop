...
export const zh = {
  ...
  'stats.detailTitle': '使用统计',
  'stats.detailSession': '本会话累计',
  'stats.detailInputUncached': '未缓存输入',
  'stats.detailCacheRead': '缓存命中读取',
  'stats.detailCacheWrite': '缓存写入',
  'stats.detailOutput': '输出',
  'stats.detailBilledInput': '计费输入合计',
  'stats.detailTotal': '总 Token',
  'stats.detailCacheHit': '缓存命中率',
  'stats.detailContext': '上下文占用',
  'stats.detailSpeed': '速度',
  'stats.detailCounts': '轮次 / 步数',
  'stats.detailTiming': '耗时',
  'stats.detailEmpty': '本会话还没有可统计的请求。',
...
export const en = {
  ...
  'stats.detailTitle': 'Usage stats',
  'stats.detailSession': 'This session',
  'stats.detailInputUncached': 'Uncached input',
  'stats.detailCacheRead': 'Cache-read',
  'stats.detailCacheWrite': 'Cache-write',
  'stats.detailOutput': 'Output',
  'stats.detailBilledInput': 'Billed input',
  'stats.detailTotal': 'Total tokens',
  'stats.detailCacheHit': 'Cache-hit rate',
  'stats.detailContext': 'Context occupancy',
  'stats.detailSpeed': 'Speed',
  'stats.detailCounts': 'Turns / steps',
  'stats.detailTiming': 'Time spent',
  'stats.detailEmpty': 'No billable requests in this session yet.',
