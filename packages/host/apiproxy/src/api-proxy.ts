 ...
 * plugin-owned entries (`agent-loop`, `shell`, `media-generation`,
 * `web-search-deepseek`) are the
...
const WEB_SETTINGS_NAMESPACES = [
  'agent-loop', 'shell', 'locale', 'media-generation', 'permission', 'ui-conversation', 'ui-theme',
  'web-search-deepseek',
] as const
